...
class contextMenuProject extends React.Component{
    render(){
        return(
            <div className="main-border" style={{background: "#FFF", height: "auto", width: "200px", position: "fixed", left: this.props.xp,top: this.props.yp, borderRadius: '3px',padding: '5px'}}>
