            ...
            <Fragment>
                ...
                style={{width: "250px", position: "fixed", height: "100%", zIndex: "1", overflowY: "auto", borderRight: "1px solid #dcdcdc"}}>
                    ...
                    <a onClick={this.props.moduleClick} style={{textDecoration: "none", color: "#000"}}>
                        <div className="tr-selectable-menu-sf bold second-font-color" style={styles.menuItem}>
                            <div style={{width: "100%"}}>
                    ...
                    <div>
                        <a style={{textDecoration: "none", color: "#000"}}>
                            <div onClick={() => this.menuClick("member-project")} 
                                className="tr-selectable-menu-sf bold second-font-color" style={styles.menuItem}>
