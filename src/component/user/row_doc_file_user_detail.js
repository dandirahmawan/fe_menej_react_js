...
class row_doc_file extends React.Component{
    ...
    render(){
        ...
        const urlFile = baseUrl+"/file/"+this.props.fileName
        ...
        return(
            <tr className='tr-selectable row-doc-file'>
                ...
                <td style={{width: "70%", paddingRight: "10px"}}>
                    <a onClick={(e) => this.props.rowClickDocFile(e, this.props.fileName)} href={urlFile} style={{color: "#000"}}>{this.props.fileName}</a>
